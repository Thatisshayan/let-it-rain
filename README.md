...
bootstrap/lock flows, `AuthGate` lock handling, entry/login auth flows, account-session
revocation handling, offline queue retries, and permission helpers, and it should be
