...
- **No automated test suite** was a Phase 11 gap. It now has one: 72 vitest tests
  across 17 files, covering JWT utilities, auth-context bootstrap/lock flows,
  ...
  item-detail loading/export/navigation flows, org settings/plan API calls,
