...
- **No automated test suite** was a Phase 11 gap. It now has one: 76 vitest tests
  across 18 files, covering JWT utilities, auth-context bootstrap/lock flows,
  ...
  flows, org settings/plan API calls, permission helpers, and mobile API-client
  auth/error handling — run via
  `npm test`.
