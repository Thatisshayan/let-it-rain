...
- **No automated test suite** was a Phase 11 gap. It now has one: 54 vitest tests
  across 13 files, covering JWT utilities, auth-context bootstrap/lock flows,
  ...
  users-list permission/query/navigation flows, offline queue behavior, org
