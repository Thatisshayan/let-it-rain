...
- **No automated test suite** was a Phase 11 gap. It now has one: 48 vitest tests
  ...
  account profile/password/session flows, offline queue behavior, org settings/plan
  API calls, permission helpers, and mobile API-client auth/error handling — run via
  `npm test`.
