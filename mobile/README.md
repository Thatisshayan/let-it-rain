...
- **No automated test suite** was a Phase 11 gap. It now has one: 80 vitest tests
  across 19 files, covering JWT utilities, auth-context bootstrap/lock flows,
  ...
  flows, orders-list role/error/navigation flows, org settings/plan API calls,
  permission helpers, and mobile API-client auth/error handling — run via
  `npm test`.
